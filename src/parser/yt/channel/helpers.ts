import type { Tab } from '@yt/components/tab'
import type { Renderer } from '@yt/core/internals'
import type { ChannelTab, ChannelTabName } from './types'
...
export const findTab =
  ...
  (tabs: ChannelTab[]): ChannelTab<T> | undefined =>
    tabs.find((tab): tab is ChannelTab<T> => 'tabRenderer' in tab && tab.tabRenderer.title === tabName)
