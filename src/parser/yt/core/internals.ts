...
export type Some<T extends SomeOptions<unknown, unknown> | SubCommand> = T extends SomeOptions<
  infer Single,
  infer Many
>
  ? Single | Runs<Many>
...
export type Command<
  Name extends string = string,
  Properties extends Record<string, unknown> = Record<never, never>,
...
export type ExtractCommand<_Command> = _Command extends Command<infer Name>
...
export type ExtractRawCommand<_Command> = _Command extends Command<infer Name>
