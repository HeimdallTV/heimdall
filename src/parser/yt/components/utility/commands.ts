...
export type ShowLessCommand<_SubCommand extends SubCommand> = Command<
	'showLess',
	Record<never, never>,
	_SubCommand
>
export type ShowMoreCommand<_SubCommand extends SubCommand> = Command<
	'showMore',
	Record<never, never>,
	_SubCommand
>
...
export type OnAddCommand<SubCommand extends OptionalSubCommand = undefined> = Command<
	'onAdd',
	Record<never, never>,
	SubCommand
>
