...
import type { SubscribeButton } from '@yt/components/button'
import { parseAttributedDescription } from '@yt/components/description/parser'
import type { AttributedDescription } from '@yt/components/description/types'
import { combineSomeText, type Text } from '@yt/components/text'
import type { UrlEndpoint, WatchEndpoint } from '@yt/components/utility/endpoint'
import { mapNavigation, type NavigationSome } from '@yt/components/utility/navigation'
import { extractNumber, fromShortHumanReadable } from '@yt/core/helpers'
import type { Renderer, Some } from '@yt/core/internals'

import type { SentimentBar, VideoActions, VideoOwner, VideoViewCount } from '../types'
...
export function processFullVideo(
  ...
  return {
    ...
    author: {
      ...
      verified: owner.badges?.some(isVerifiedBadge)
    ...
    dislikeCount,
    likeStatus,
    viewCount: extractNumber(combineSomeText(viewCountRenderer.viewCount)),
