...
export const Thumbnail: FC<ThumbnailProps> = ({ staticThumbnail, animatedThumbnail, children }) => {
...
export const LengthBadge: FC<LengthBadgeProps> = ({ type, length }) => {
...
export const VideoThumbnail: FC<ThumbnailProps & LengthBadgeProps> = props => (
  <Thumbnail {...props}>
    <LengthBadge {...props} />
  </Thumbnail>
)
