...
type VideoShelfProps = Omit<ShelfProps, "expanded" | "onExpandedChange"> & {
	size: "sm" | "md";
	videos: std.Video[];
};
...
type ChannelShelfProps = Omit<ShelfProps, "expanded" | "onExpandedChange"> & {
	size: "sm" | "md";
	channels: std.Channel[];
};
export const ChannelShelf: FC<ChannelShelfProps> = ({
	size,
	channels,
	...props
}) => {
