      ...
      >
        <Switch
          ...
          onChange={(event) =>
            setSegments({
              ...segments,
              enableExclusiveAccess: event.currentTarget.checked,
            })
          }
        />
      </Label>
      ...
      >
        <Switch
          ...
          onChange={(event) =>
            setSegments({
              ...segments,
              enableChapters: event.currentTarget.checked,
            })
          }
        />
      </Label>
  ...
  return (
    <PlayerSegmentOptions
      ...
      behaviours={[
        ...
        {
          label: 'Automatically jump to',
          value: PlayerSegmentHighlightBehavior.Jump,
        },
      ]}
...
function PlayerSegmentCategory({
  ...
  category: std.PlayerSegmentCategory
  title: string
  description: string
}) {
