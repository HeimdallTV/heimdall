...
export const usePlayerHotkeys = (ref: React.RefObject<HTMLElement>) => {
  ...
  useHotkeys([
    ...
    ['f', () => (document.fullscreenElement ? document.exitFullscreen() : ref.current?.requestFullscreen())],
    ...
    ['1', () => player.seekMS.set(player.durationMS.get() * 0.1)],
    ['2', () => player.seekMS.set(player.durationMS.get() * 0.2)],
    ['3', () => player.seekMS.set(player.durationMS.get() * 0.3)],
    ['4', () => player.seekMS.set(player.durationMS.get() * 0.4)],
    ['5', () => player.seekMS.set(player.durationMS.get() * 0.5)],
    ['6', () => player.seekMS.set(player.durationMS.get() * 0.6)],
    ['7', () => player.seekMS.set(player.durationMS.get() * 0.7)],
    ['8', () => player.seekMS.set(player.durationMS.get() * 0.8)],
    ['9', () => player.seekMS.set(player.durationMS.get() * 0.9)],
  ])
}
